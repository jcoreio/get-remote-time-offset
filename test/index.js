...
describe('getRemoteTimeOffset', () => {
  ...
  it(`rejects timeout too low`, async function (): Promise<void> {
    await expect(getRemoteTimeOffset(
      () => Promise.resolve(Date.now()),
      {numQueries: 3, timeBetweenQueries: 2, timeout: 3}
